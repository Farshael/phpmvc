...
<body>
<div class="container">
    <a href="<?= BASE_URL;?>/Pinjam/index"><i class="fas fa-reply" style="color: #132043; margin-top:2rem; font-size:24px;"></i></a>
    ...
    <form action="<?=BASE_URL;?>/Pinjam/simpanPinjam" method="post">
        ...
        <div class="card-footer" style="float:right;">
            <button type="submit" class="btn  "  style="background-color: #132043; color: white;">Submit</button>
        </div>
    </form>
</body>
</div>