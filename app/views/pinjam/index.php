...
<div class="container">
    ...
    <div>
    <a href="<?= BASE_URL;?>/Pinjam/tambah" class="btn text-white" style="background-color: #132043;"><i class="fa-solid fa-plus"></i> Peminjaman</a>
    </div>
    <div class="d-flex">
    <form action="<?= BASE_URL;?>/Pinjam/cari" method="post" class= "d-flex" style="margin-right: 0.5rem;">
        <input type="text" name="search" id="" class="form-control" style="border: solid 1px grey; margin-right: -0.1rem" placeholder="Cari Pinjaman..">
                  ...
                  <td> 
                    <?php
                        if ($status == 'belum kembali') {
                            ...
                            echo '<a href="' . BASE_URL . '/pinjam/edit/' . $row['id'] . '" class="btn btn-success"><i class="fa-solid fas fa-pen"></i></a>';
                        }
                    ?>
